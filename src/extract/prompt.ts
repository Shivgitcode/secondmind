import { type ExtractedNote, NOTE_TYPES, isNoteType } from '../core/types.js';
...
export function userPrompt(transcript: string, project: string): string {
 ...
 */
export function parseNotes(reply: string): ExtractedNote[] {
  ...
  return notes.flatMap((raw): ExtractedNote[] => {
